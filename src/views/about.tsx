...
import {
  Heart, Globe, Users, Shield, ArrowRight,
  CheckCircle, Handshake, BookOpen, TrendingUp, MapPin,
} from 'lucide-react';
...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>About Youth Employment Canada — Canada's Youth Employment Network</title>
        <meta name="description" content="Learn about Youth Employment Canada — our mission, team, values, and commitment to connecting young Canadians with inclusive employers across Canada." />
      </Helmet>
      ...
      <section className="bg-[#F8FAFC] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.p variants={fadeUp} className="text-[#2563EB] font-semibold text-sm uppercase tracking-widest mb-4">
            ...
            <motion.p variants={fadeUp} className="text-[#475569]/75 text-lg leading-relaxed mb-8">
              Youth Employment Canada is Canada's dedicated job platform connecting young Canadians with employers across the country.
              We believe meaningful employment builds confidence, skills, and economic opportunity for young people starting their careers.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              <Link to="/employers">
                <Button variant="outline" className="border-[#2563EB] text-[#2563EB] hover:bg-[#2563EB]/10 font-semibold px-7">
                  Hire with Us
                </Button>
              </Link>
            </motion.div>
      ...
      <section className="bg-[#0F172A] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-[#2563EB] font-semibold text-sm uppercase tracking-widest mb-4">Our Mission</p>
              <h2
              ...
              <p className="text-white/70 leading-relaxed mb-5">
                Youth Employment Canada was created to address a clear need: a dedicated space where
                young Canadians can find meaningful employment and where employers can connect
                with motivated early-career talent.
              </p>
              <p className="text-white/70 leading-relaxed">
                We are committed to supporting inclusive employment pathways and building features
                that help young people access opportunities across Canada. Our platform is designed
                to support diverse experiences and regional needs for youth employment.
              </p>
            </motion.div>
              ...
              <div className="bg-white/8 border border-white/10 rounded-3xl p-10">
                ...
                <ul className="flex flex-col gap-4">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-[#FAF5EE]/75 text-sm leading-relaxed">
                      <CheckCircle size={15} className="text-[#C8782A] flex-shrink-0 mt-0.5" />
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          >
            {values.map((v) => (
              ...
              >
                ...
                <p className="text-[#475569]/70 text-sm leading-relaxed">{v.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="bg-[#F8FAFC] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#6B3A2A]/70 max-w-2xl mx-auto leading-relaxed">
              Our team is focused on helping youth access better employment opportunities across Canada while supporting employers in finding and developing young talent.
            </motion.p>
          </motion.div>
          ...
          >
            {team.map((member) => (
              ...
              >
                ...
                <p className="text-[#C8782A] text-sm font-semibold mb-1">{member.role}</p>
                <p className="text-[#6B3A2A]/50 text-xs mb-4 italic">{member.nation}</p>
                <p className="text-[#6B3A2A]/70 text-sm leading-relaxed">{member.bio}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#475569]/70 max-w-2xl mx-auto leading-relaxed">
              We go beyond job listings. Youth Employment Canada actively works to remove barriers, educate
              employers, and create pathways to lasting, dignified employment for youth across Canada.
            </motion.p>
          </motion.div>
            ...
            {commitments.map((c) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#475569]/70 text-sm leading-relaxed">{c.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            >
              <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" aria-hidden="true">
                <circle cx="18" cy="18" r="16" stroke="#2563EB" strokeWidth="2" fill="none" />
                <circle cx="18" cy="18" r="10" stroke="#2563EB" strokeWidth="1.5" fill="none" opacity="0.6" />
                <circle cx="18" cy="18" r="4" fill="#2563EB" />
                <path d="M18 2 Q26 10 18 18 Q10 10 18 2Z" fill="#2563EB" opacity="0.25" />
              </svg>
            </motion.div>
            <motion.p variants={fadeUp} className="text-[#2563EB] font-semibold text-sm uppercase tracking-widest mb-4">
              Land Acknowledgement
            ...
            <motion.p variants={fadeUp} className="text-[#475569]/75 leading-relaxed text-lg">
              Youth Employment Canada is committed to supporting young people across Canada by helping them
              access meaningful employment opportunities, career growth, and strong employer connections. We
              work to create a respectful, inclusive, and supportive platform that helps youth build a brighter
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.p variants={fadeUp} className="text-white/80 mb-8 text-lg">
              Whether you're looking for work or looking to hire — Youth Employment Canada is here for you.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4 justify-center">
              <Link to="/register">
                <Button size="lg" className="bg-white text-[#2563EB] hover:bg-[#F8FAFC] font-semibold px-10">
                  Get Started Free
                </Button>
              </Link>
              <Link to="/contact">
